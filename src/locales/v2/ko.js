  ...
  help_v2: {
    ...
    student: {
      home: {
        ...
        still_need_body: '학생 경로가 더 정리되기 전까지 일부 전문적인 주제는 도움말 v1에 남아 있을 수 있습니다.',
        still_need_link: '도움말 v1 열기'
      },
      join: {
        badge: '학생',
        ...
        start_items: [
          '도장 찾기로 도장을 둘러보고 상세 정보와 갤러리를 본 뒤 가입 신청하세요.',
          '도장 검색으로 직접 검색하거나 도장 QR 코드를 스캔하세요.'
        ],
        discover_title: '도장 찾기',
        discover_items: [
          '도장 섹션에서 도장 찾기를 여세요.',
          '도장 목록을 둘러보세요.',
