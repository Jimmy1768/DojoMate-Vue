  ...
  help_v2: {
    ...
    layout: {
      ...
      nav: {
        ...
        business_overview: 'Business 개요',
        compare_business_pages: 'Business 페이지 비교',
        ...
        portal_register: 'Portal 등록',
        portal_members: 'Portal 멤버',
        portal_ranks: 'Portal 랭크',
        portal_cards: 'Portal 카드',
        portal_reports: 'Portal 리포트',
        ...
        activate_tools_and_premium: '도구와 Premium 활성화',
        timetable: 'Timetable',
    ...
    owner_home: {
      ...
      portal_title: 'Portal 워크플로',
      portal_body: '일부 작업은 일상적인 DojoMate 앱 화면이 아니라 Source Combatives AFL의 Affiliate Portal에서 진행됩니다.',
      portal_link: 'Affiliate Portal 가이드 열기',
      paid_title: '유료 기능',
    ...
    admin_home: {
      ...
      delegated_link: 'Staff Access 검토',
      know_title: '알아둘 점',
      know_items: [
    ...
    business: {
      overview: {
        ...
        cards: [
          {
            title: '누가 가르칠지 정하기',
            body: 'Instructors를 사용해 누가 수업에 배정될 수 있는지 결정합니다.',
            cta: 'Instructors 가이드 열기',
            link: '/help-v2/business/instructors'
          },
          {
            title: '누가 도장을 관리할지 정하기',
            body: 'Staff Access를 사용해 관리자 접근 권한을 부여하거나 업데이트합니다.',
            cta: 'Staff Access 가이드 열기',
        ...
        know_items: [
          ...
          '어디서 시작해야 할지 모르겠다면 팀 설정의 첫 단계로는 Instructors가 가장 적합하고, 그다음이 Staff Access, 마지막이 Analytics입니다.'
        ],
        compare_link: 'Business 페이지 비교',
        next_title: '다음 단계',
      ...
      compare: {
        ...
        start_body: '질문이 “이 사람이 가르칠 수 있나?”라면 Instructors부터 시작하세요. “이 사람이 도장을 관리할 수 있나?”라면 Staff Access로 가세요. “보수나 리포트는 어디서 보나?”라면 Analytics로 가세요.',
      ...
      instructors: {
        badge: 'Business',
        title: '누가 가르칠지 정하기',
        intro: 'Business → Instructors를 사용해 누가 수업에 배정될 수 있는지 결정합니다.',
        ...
        next_link: 'Staff Access로 이동'
      },
      staff_access: {
        badge: 'Business',
        paid_badge: '유료 도구',
        title: '누가 도장을 관리할지 정하기',
        intro: 'Business → Permissions를 사용해 팀에 관리자 접근 권한을 부여하거나 업데이트합니다.',
        use_title: '이 페이지를 사용하는 경우',
        use_items: [
        ...
        know_items: [
          ...
          'Permissions는 관리자 접근 권한을 제어합니다. 누가 가르치는지는 여기서 정하지 않습니다.',
          '현재 접근 영역은 Schedule, Members, Cards, Timetable입니다.',
          '이 기능은 entitlement로 제어됩니다. 도구가 비활성 상태면 위임된 스태프 권한은 적용되지 않습니다.'
        ],
        mistake_title: '자주 하는 실수',
        mistake_body: '누군가에게 가르치는 책임을 주는 것과 관리자 접근 권한을 주는 것은 별도의 설정입니다. 가르치는 역할은 Instructors, 관리자 역할은 Permissions를 사용하세요.',
        compare_link: 'Business 페이지 비교',
      ...
      analytics: {
        ...
        know_items: [
          'Analytics에서 보수를 바꿔도 그 사람이 강사가 되는 것은 아닙니다.',
          '그 사람이 가르쳐야 한다면 Instructors에서 그 역할을 추가하세요.',
          '그 사람이 도장을 관리해야 한다면 Permissions에서 해당 접근 권한을 부여하세요.',
    ...
    schedule: {
      overview: {
        ...
        intro: 'Schedule 영역을 사용해 수업을 만들고, 수업 세부 정보를 조정하고, 필요할 때 학생 예약을 도와줍니다.',
        start_title: '해야 할 일부터 시작하세요',
        cards: [
          {
            title: '수업 만들기',
        ...
        before_link: 'Instructors 검토'
      },
      create: {
        badge: 'Schedule',
        title: '수업 만들기',
        intro: '학생이 예약하길 원하는 날짜에 수업을 추가하려면 Schedule을 사용하세요.',
        before_title: '시작하기 전에',
        before_items: [
          '수업을 만들기 전에 최소 한 명의 강사가 선택되어 있어야 합니다.',
          'Schedule은 기본으로 오늘 날짜를 열기 때문에 먼저 올바른 날짜를 선택하세요.',
    ...
    cards: {
      overview: {
        ...
        know_items: [
          ...
          '가끔 예외 상황에서는 활성 카드를 수동으로 조정할 수 있습니다. 가장 흔한 용도는 만료 시간을 연장하는 것이며, 특히 Pause Cards를 사용하지 않을 때 그렇습니다.'
        ],
        ...
        support_records_body: '기록, 상태 검토, 비정상 카드 상태 후속 확인이 필요할 때 records를 사용하세요.',
      ...
      create_template: {
        ...
        intro: 'Cards → Create Card Template를 사용해 도장에서 발급할 카드 유형을 만드세요.',
        before_title: '시작하기 전에',
        before_items: [
        ...
        steps_title: '단계',
        steps_items: [
          'Cards → Create Card Template를 엽니다.',
        ...
        back_link: 'Cards 개요로 돌아가기',
        next_link: 'Issue Cards로 이동'
      },
      issue: {
        badge: 'Cards',
        title: '멤버십 카드 발급하기',
        intro: 'Cards → Assign Cards를 사용해 한 명 이상의 멤버에게 활성 카드를 부여합니다.',
        steps_title: '단계',
        steps_items: [
          'Cards → Assign Cards를 엽니다.',
          '발급할 카드 템플릿을 선택합니다.',
          '한 명 이상의 멤버를 선택합니다.',
          '선택한 멤버를 검토합니다.',
    ...
    members: {
      ...
      quick: {
        badge: 'Members',
        title: '멤버를 직접 추가하기',
        intro: '일반 Join Academy 신청 흐름을 기다리지 않고 직접 등록하고 싶을 때 quick enrollment를 사용하세요.',
        ...
        path_body_2: 'Quick enrollment는 추가 도움이 필요한 사람이나 스스로 설정을 마치기 어려운 사람에게 가장 잘 맞습니다.',
        steps_title: '단계',
        steps_items: [
        ...
        know_title: '알아둘 점',
        know_items: [
          'Quick enrollment는 일반 pending/accepted 신청 흐름을 건너뜁니다.',
        ...
        compare_link: 'Quick Enrollment와 Applications 비교하기',
        next_title: '다음 단계',
        next_body: '계정이 도장에 들어오면 다음으로 자주 하는 작업은 멤버십 카드를 발급하는 것입니다.',
        back_link: 'Members Overview로 돌아가기',
        next_link: 'Issue Cards로 이동'
      },
      compare: {
        badge: 'Members',
        title: 'Quick Enrollment와 Applications 중 선택하기',
        intro: '두 흐름 모두 사람을 도장에 들이지만, 서로 다른 상황을 위한 것입니다.',
        quick_title: '이럴 때 Quick Enrollment 사용',
        quick_items: [
          '계정을 직접 만들고 싶을 때',
        ...
        quick_link: 'Quick Enrollment 열기',
        apps_title: '이럴 때 Applications 사용',
        apps_items: [
          '멤버가 스스로 계정을 만들길 원할 때',
          '오너가 모든 계정을 직접 만들지 않아도 도장이 확장되길 원할 때',
          '그 멤버가 Join Academy 흐름을 스스로 따라갈 수 있을 때'
        ],
        apps_link: 'Academy Applications 열기',
        rule_title: '간단한 규칙',
        rule_body: '가능하면 멤버가 스스로 만들게 두세요. 추가 도움이 필요하거나 등록을 직접 처리하고 싶을 때 Quick Enrollment를 사용하세요.'
      },
      applications: {
        badge: 'Members',
        title: '도장 신청 검토하기',
        ...
        steps_title: '단계',
        steps_items: [
          'Members → Add/Reject Members를 엽니다.',
          '보류 중인 신청 목록을 검토합니다.',
        ...
        compare_link: 'Applications와 Quick Enrollment 비교하기',
        mistake_title: '자주 하는 실수',
      ...
      reject: {
        ...
        reject_title: '거절 방식',
        reject_items: [
          'Members → Members List에서 멤버 프로필을 엽니다.',
          'Reject를 눌러 그 사람을 도장에서 제거합니다.',
          '활성 카드를 가진 멤버는 거절 전에 먼저 정리되어야 합니다.'
        ],
        ban_title: '차단 방식',
        ban_items: [
          '거절된 멤버는 Members → Rejected List에 나타납니다.',
    ...
    tools: {
      overview: {
        ...
        pause_body: '카드 기간을 잠시 멈춰야 한다면 Pause Cards를 사용하세요.',
        pause_link: 'Pause Cards 열기',
        ...
        know_items: [
          ...
          '도구는 개별로 제공될 수도 있고 Premium Package에 포함될 수도 있습니다.',
      ...
      activate: {
        badge: '도구',
        paid_badge: '유료 도구',
        title: '도구와 Premium 활성화',
        intro: 'AFL의 Features 페이지에서 도구 그룹을 확인하고, 무료 체험을 시작하고, 패키지를 구매하고, 도장에서 활성화된 패키지 도구를 관리합니다.',
        where_title: '이동 위치',
        where_body: 'AFL System → Features를 여세요. 현재 Rails가 관리하는 도구 활성화, 패키지 상태, 체험 상태의 진입점입니다.',
        organized_title: '페이지 구성 방식',
        organized_items: [
          '도구는 개별로도 제공됩니다.',
          'Features 페이지는 Essential Tools, Advanced Tools, 그리고 패키지 섹션으로 나뉩니다.',
          'Premium Package에는 4개의 productivity 도구가 포함됩니다.',
          '현재 UI에는 Pro Package도 표시됩니다.',
          '첫 사용자라면 90일 Premium 체험을 시작할 수 있습니다.'
        ],
        ...
        features_title: 'Features 페이지에서 볼 수 있는 항목',
        features_items: [
          'Start Free Trial',
        ...
        know_items: [
          ...
          '패키지 체험 동작은 중복을 고려하므로 Pro와 Premium이 서로를 단순히 초기화하지는 않습니다.'
        ],
        guides_title: '유료 가이드',
        staff_access: 'Staff Access',
        analytics: 'Analytics',
        support_desc: 'Features, 구독, 체험 상태, 기타 AFL 전용 웹 흐름 관련 질문은 Source Combatives의 AFL Portal 게시판을 이용하세요.',
      ...
      broadcast: {
        ...
        intro: 'AFL의 Broadcasts는 도장 공지나 훈련 게시물을 멤버에게 발행할 때 사용합니다. 이것은 일방향 발행 도구이며 채팅, 답글, 소셜 피드가 아닙니다.',
        where_title: '위치',
        where_items: [
          'AFL 시스템 내비게이션에서 Broadcasts를 엽니다.',
          '현재 AFL 기준으로 Broadcast는 사실상 오너 전용입니다.',
          'Features 페이지에서 Broadcast는 Pro 도구로 표시됩니다.'
        ],
        flow_title: '작성 흐름',
        flow_steps: [
          'AFL에서 Broadcasts를 엽니다.',
          '게시할 stream 탭을 선택합니다.',
          '메시지 본문을 작성합니다.',
        ...
        know_items: [
          ...
          'Broadcast는 AFL에서 작성되고 이후 앱에서 소비됩니다.'
        ],
    ...
    portal: {
      overview: {
        badge: 'Portal',
        title: 'AFL의 Affiliate Portal 사용',
        intro: 'Affiliate Portal은 Source Combatives AFL의 웹 화면입니다. 일반적인 일상 앱 화면보다 무거운 오너 작업, 특히 등록, 심사, 랭크, 카드, 리포트, 패키지 활성화에 사용합니다.',
        workflows_title: '주요 AFL 워크플로',
        ...
        know_title: '알아둘 점',
        know_items: [
          '대부분의 AFL 페이지는 사실상 오너 전용입니다.',
          '주요 예외는 Monthly Reports이며, 리포트 권한이 있으면 비오너 스태프도 볼 수 있습니다.',
          'AFL 변경 사항은 멤버 상태, 카드, 랭크 데이터, 도구 활성화 등에서 앱에 직접 반영되는 경우가 많습니다.'
        ],
        support_desc: 'Affiliate Portal, Portal 설정 문제, 기타 AFL 전용 웹 워크플로 질문은 Source Combatives의 AFL Portal 게시판을 이용하세요.',
        support_button: 'AFL Portal 게시판 열기'
      },
      register: {
        badge: 'Portal',
        title: 'Affiliate Portal에서 등록하기',
        intro: 'AFL의 Register는 Portal에서 새 도장 멤버를 만들 때 사용합니다. 이것은 한 화면짜리 폼이 아니라 여러 단계의 마법사입니다.',
        flow_title: '흐름',
        flow_steps: [
          'AFL에서 Register를 열고 먼저 보호자 또는 성인 정보를 입력합니다.',
          '보호자로 등록하는 경우 자녀 단계에서 자녀 계정을 추가합니다.',
          '요약을 검토하고 Confirm & Create로 마칩니다.',
          '계속 작업해야 하면 Register Another 또는 Go to Members를 사용합니다.'
        ],
        labels_title: '현재 보일 수 있는 라벨',
        ...
        know_items: [
          ...
          '보호자는 Pending 상태로 남을 수 있고 나중에 Members에서 다시 이어갈 수 있습니다.',
          '여기서 만든 계정은 일반 DojoMate 사용자 계정이 되며 앱이 사용하는 도장 멤버 데이터에도 나타납니다.'
        ],
        next_title: '다음 단계',
        members_link: 'Members',
        cards_link: 'Cards',
        support_desc: '등록 마법사, Pending 보호자 재개, 기타 AFL 온보딩 문제는 AFL Portal 게시판을 이용하세요.',
        support_button: 'AFL Portal 게시판 열기'
      },
      members: {
        badge: 'Portal',
        title: 'Portal 멤버 관리',
        intro: 'AFL의 Members는 도장 멤버 상태를 심사할 때 사용합니다. 단순한 목록이 아니라 상태 중심 영역입니다.',
        jobs_title: '주요 작업',
        jobs_items: [
          'Pending Users, Recently Accepted, 보호자 계정, 성인 멤버, 거절된 사용자, 차단된 사용자를 검토합니다.',
          '심사 작업에는 Accept, Reject, Ban을 사용합니다.',
          '기존 계정을 이메일로 연결하려면 Add Member by Email을 사용합니다.',
          '대기 중인 보호자 흐름을 이어가려면 Resume Onboarding을 사용합니다.'
        ],
        labels_title: '현재 보일 수 있는 라벨',
        ...
        confusion_items: [
          'Add Member by Email은 이미 존재하는 계정에만 동작합니다.',
        ...
        cards_link: 'Cards',
        support_desc: '멤버 상태, 보호자/자녀 심사, 기존 계정 이메일 연결 문제는 AFL Portal 게시판을 이용하세요.',
        support_button: 'AFL Portal 게시판 열기'
      },
      ranks: {
        badge: 'Portal',
        title: '랭크와 프로그램 관리',
        intro: 'AFL의 Ranks는 도장 랭크 프로그램을 설정하고 멤버 progression을 업데이트할 때 사용합니다. 이것은 단일 전역 설정이 아니라 다중 프로그램 워크플로입니다.',
        jobs_title: '주요 작업',
        jobs_items: [
        ...
        know_items: [
          ...
          '여기서 기록한 변경은 앱이 읽고 표시하는 progression 데이터에 반영됩니다.'
        ],
        next_title: '다음 단계',
        members_link: 'Members',
        analytics_link: 'Analytics',
        support_desc: '랭크 프로그램 설정, roster 등록, Ranks review 모달 문제는 AFL Portal 게시판을 이용하세요.',
        support_button: 'AFL Portal 게시판 열기'
      },
      cards: {
        badge: 'Portal',
        title: 'Portal 카드 사용',
        intro: 'AFL의 Cards는 템플릿, 발급, 활성 카드 관리, 일시정지 제어, 기록까지 포함하는 전체 웹 카드 워크플로가 필요할 때 사용합니다.',
        ...
        app_cards_link: '앱의 Cards',
        support_desc: 'AFL Cards의 템플릿, 발급, 활성 카드, 일시정지, 기록 관련 질문은 AFL Portal 게시판을 이용하세요.',
        support_button: 'AFL Portal 게시판 열기'
      },
      reports: {
        badge: 'Portal',
        title: 'Portal 리포트 검토',
        intro: 'AFL의 Reports는 시스템이 이미 생성한 월간 재무 리포트를 검토할 때 사용합니다. 이 페이지는 읽기 전용입니다.',
        flow_title: '사용 방법',
        flow_items: [
        ...
        know_items: [
          ...
          '리포트 데이터는 더 넓은 analytics 및 시스템 파이프라인에서 옵니다.',
          '잠금 상태가 보이면 Features로 이동하세요.'
        ],
        support_desc: '리포트 접근 문제, Analytics 잠금 상태, AFL 월간 리포트 관련 질문은 AFL Portal 게시판을 이용하세요.',
        support_button: 'AFL Portal 게시판 열기'
      }
    }
  }
