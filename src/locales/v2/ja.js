  ...
  help_v2: {
    ...
    student: {
      ...
      memberships: {
        ...
        know_title: '知っておくこと',
        know_items: [
          '正しいステータスが表示されない場合、道場側でまだ申請が承認されていない可能性があります。',
          'Membership に関わる一部の操作は、今でも道場スタッフ側で行う必要があります。'
        ],
        next_title: '次のステップ',
        booking_link: '予約'
      },
      booking: {
        badge: '受講者',
        title: 'クラスを予約する',
        intro: '道場に参加し、使えるカードを持っている状態で、予約を使ってクラスに参加します。',
        steps_title: 'よくある流れ',
        steps_items: [
          'まず正しい道場を選ぶ。',
          'スケジュールを開いて予約可能なクラスを見る。',
          'カード種別に合うクラスを選ぶ。',
          '予約を完了する。'
        ],
        know_title: '知っておくこと',
        know_items: [
          '予約時にカードが表示されない場合は、カード種別とクラス種別が一致しているか確認してください。',
          '予約が通常の主導線であり、回数消化や関連記録はそこから処理されます。'
        ],
        next_title: '次のステップ',
        attendance_link: '出席記録'
      },
      alerts: {
        badge: '受講者',
        title: 'システム通知を見る',
        intro: 'アカウント、道場、関連する流れに関する重要な更新を確認するために使います。',
        know_title: '知っておくこと',
        know_items: [
          'System Alerts が現在の製品用語です。',
          'チャットでも双方向メッセージでもありません。'
        ]
      },
      attendance: {
        badge: '受講者',
        title: '出席記録を見る',
        intro: 'これまで参加したクラスを振り返るために出席記録を使います。',
        know_title: '知っておくこと',
        know_items: [
          '予約と出席が正しく記録されているか確認する助けになります。',
          '記録がおかしいと感じたら道場に連絡してください。'
        ]
      },
      broadcast: {
        badge: '受講者',
        title: 'アプリで道場の Broadcast を読む',
        intro: 'アプリの Broadcast を使って、道場からの更新やトレーニング投稿を読みます。これは読むことを中心にした情報フィードであり、チャット、コメント、返信ではありません。',
        where_title: 'どこにあるか',
        where_items: [
        ...
        actions_title: 'できること',
        actions_items: [
          'Updates と Training タブを切り替える。',
          'プルして再読み込みする。',
          '本文と画像キャプションを読む。',
          '画像をタップして全画面表示し、外側をタップして閉じる。'
        ],
        screen_title: '画面に表示されるもの',
        screen_items: [
          'タイトル: Broadcast',
          '上部に選択中の道場名',
          'タブ: Updates と Training',
          '各カードには著者名、または Academy Admin が表示されることがあります',
          '公開日時',
          '本文、画像サムネイル、任意の画像キャプション'
        ],
        limits_title: '空状態と現在の制限',
        limits_items: [
          '道場が選ばれていない場合は Select an academy first が表示されることがあります。',
          '空のストリームでは Updates coming soon や No visible broadcasts are available in this stream yet. が表示されることがあります。',
          '現在のメンバー向け Broadcast は読み取り専用です。',
          'いいね、コメント、返信、リアクション、共有、メンバー投稿はありません。'
        ],
        know_title: '知っておくこと',
        know_items: [
