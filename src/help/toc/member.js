...
export const memberSections = [
...

  {
    ...
    items: [
      ...
      { path: '/help/settings/privacy-settings',  labelKey: 'help.toc.settings.privacy',           titleKey: 'help.settings.privacy.title',           bodyKeys: ['help.settings.privacy.intro', 'help.settings.privacy.notifications', 'help.settings.privacy.marketing', 'help.settings.privacy.booking', 'help.settings.privacy.analytics', 'help.settings.privacy.instructors'] },
